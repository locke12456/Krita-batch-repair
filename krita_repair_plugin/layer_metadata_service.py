...
class LayerMetadataService:
    ...
    def _flatten_known_fields(self, metadata: dict[str, Any]) -> dict[str, Any]:
        ...
        allowed = {
            ...
            schema.KEY_RESULT_SELECTED,
            schema.KEY_RESULT_ACTIVE,
            schema.KEY_RESULT_VISIBLE,
            schema.KEY_RESULT_REMOVED,
            schema.KEY_PROMPT_TYPE,
            schema.KEY_PROMPT_TYPE_PROMPT,
            schema.KEY_PROMPT_TYPE_APPLIED,
            ...
            schema.KEY_MERGE_STATUS,
            schema.KEY_MERGE_ERROR,
            schema.KEY_MERGED_LAYER_ID,
            schema.KEY_MERGED_LAYER_NAME,
            ...
            "repair_plugin.selected",
            "repair_plugin.active",
            "repair_plugin.visible",
            "repair_plugin.removed",
            "repair_plugin.prompt_type",
            "repair_plugin.prompt_type_prompt",
            "repair_plugin.prompt_type_applied",
            "repair_plugin.merge_status",
            "repair_plugin.merge_error",
            "repair_plugin.merged_layer_id",
            "repair_plugin.merged_layer_name",
